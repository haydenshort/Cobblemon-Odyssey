# 🎮 Cobblemon Odyssey - Version 0.6.0-beta
...
- Apothic Amendments (0.1.4)
- Apothic Supplementaries (0.1.0)
- Apotheosis x Iron's Spellsbooks Compat (2.1.3)
- Ancient Reforging (1.8.4)
- Allurment (5.0.1)
- Simply Bows (0.1.2)
...
- ChoiceTheorem's Enhanced Villages (3.6.3)
...
<details>
<summary><b>View Removed Mods</b></summary>

**Worldgen & Structures (20):**
- Better Villages, Tectonic, TerraBlenderFix, Terralith
- Regions Unexplored: Expansion, Explorify
- Formations Nether, Formations Overworld
- Towns and Towers, Nether Depths Upgrade
- Moog's Voyager/Soaring/Nether/End Structures
- It Takes Pillage Continuation
- Better Nether, Better End, BC Lib, WorldWeaver

**Combat & Magic (6):**
- Iron's Spells Dynamic Skill Tree
- Critical Strike
- Psi
- Starcatcher
- Tide 2
...
**Utility (5):**
- Easy Anvils, Easy Magic, Enchanting Infuser
- Just Zoom
- Raised

**Other (5):**
- Complete Cobblemon Collection Resource/Data Pack (2.0)
- Extra Disks, KeybindsPurger
- Collector's Album, Mushroom Quest, Create: Deep Dark
...
| Advanced Loot Info | 1.7.3 → 1.8.3 |
...
Thanks for playing **Cobblemon Odyssey**! Report bugs and share feedback on our Discord.
